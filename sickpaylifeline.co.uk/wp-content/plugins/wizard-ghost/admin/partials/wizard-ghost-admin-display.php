			...
			<div class="wizard-ghost-admin-section">
				...
				<form method="post" action="">
					...
					<div class="form-group">
						...
						<p class="description"><?php esc_html_e( 'Form submissions will be sent to this email address.', 'wizard-ghost' ); ?></p>
						<input type="email" id="wizard_ghost_email" name="wizard_ghost_email" value="<?php echo esc_attr( get_option( 'wizard_ghost_email' ) ); ?>" class="regular-text" required>
					</div>
					...
					<div class="form-group">
						...
						<p class="description"><?php esc_html_e( 'Users will be redirected to this URL after successful form submission.', 'wizard-ghost' ); ?></p>
						<input type="url" id="wizard_ghost_redirect_url" name="wizard_ghost_redirect_url" value="<?php echo esc_attr( get_option( 'wizard_ghost_redirect_url' ) ); ?>" class="regular-text" placeholder="https://example.com/thank-you/">
					</div>

					<p class="submit">
						<button type="submit" class="button button-primary"><?php esc_html_e( 'Save Settings', 'wizard-ghost' ); ?></button>
						<button type="submit" name="wizard_ghost_test_email" class="button button-secondary" style="margin-left: 10px;"><?php esc_html_e( 'Send Test Email', 'wizard-ghost' ); ?></button>
					</p>
				</form>
			</div>
