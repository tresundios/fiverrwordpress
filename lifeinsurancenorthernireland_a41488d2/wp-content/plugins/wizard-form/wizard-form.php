...
function process_complete_form() {
    ...
    $subject = 'Quote Request | Life Insurance Northern Ireland';
    //$message = 'New Quote Request received for Life Insurance Under 30:\n\n';
    $headers = array('Content-Type: text/html; charset=UTF-8');
    
    $message ="<html>";
    $message .="<head><title>Quote Request | Life Insurance Northern Ireland</title></head>";
    $message .="<body>";
    $message .="<img src='https://lifeinsurancenorthernireland.co.uk/wp-content/uploads/2025/05/cropped-Life-Insurance-Northern-Ireland.png' alt='Life Insurance Under 30'>";
